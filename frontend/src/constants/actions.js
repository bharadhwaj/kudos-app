...
export const LOADING = {
  START_REGISTER_LOADING: 'kudos/Loading/START_REGISTER_LOADING',
  STOP_REGISTER_LOADING: 'kudos/Loading/STOP_REGISTER_LOADING',
  START_LOGIN_LOADING: 'kudos/Loading/START_LOGIN_LOADING',
  STOP_LOGIN_LOADING: 'kudos/Loading/STOP_LOGIN_LOADING',
  START_GET_ORGANISATION_LOADING:
    'kudos/Loading/START_GET_ORGANISATION_LOADING',
  STOP_GET_ORGANISATION_LOADING: 'kudos/Loading/STOP_GET_ORGANISATION_LOADING',
